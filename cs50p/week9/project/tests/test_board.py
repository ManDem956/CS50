...
class TestBoard:
    ...
    @pytest.fixture(scope="class")
    def players(self, player_x, player_o):
        return (player_x, player_o)

    @pytest.fixture
    def players_cycle(self, player_x, player_o):
        return itertools.cycle((player_x, player_o))

    @pytest.fixture
    def board(self, request, players_cycle):
    ...
    def test_board_make_moves(self, players_cycle, board, moves, expected, expectation):
        with expectation:
            for i in moves:
